...
from bullet_simulation.helper_robot_simulator_nodes import bullet_simulator_node, ball_shooter_node
...
def launch_setup(context):
    ...
    ball_topic_remapping = [
        (
            ...
            f"/sensors/ball_triangulation/{robot_technical_name_with_tool}/points",
        ),
        (
            "/sensors/gcs/spin_estimation/spins",
            f"/sensors/gcs/spin_estimation/{robot_technical_name_with_tool}/spins",
        ),
    ]
    launched_nodes += [
        Node(
